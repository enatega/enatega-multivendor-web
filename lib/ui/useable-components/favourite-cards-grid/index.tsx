...
const FavouriteCardsGrid: React.FC<IFavouriteGridProps> = (props) => {
  ...
  const displayItems = props.type === "seeAllFavourites" ? items : items.slice(0, 4);
  return (
    <div className={twMerge("grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  gap-4 sm:gap-6"
    )}>
