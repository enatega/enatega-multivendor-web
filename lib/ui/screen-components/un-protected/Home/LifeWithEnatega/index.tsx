  ...
  return (
    <div className='mt-[40px] mb-[40px]'>
      <div className='flex flex-col justify-center items-center'>
        <h1 className='text-[60px] font-extrabold m-4'> LIFE TASTES BETTER WITH ENATEGA</h1>
        <p className='m-4 text-[28px]'>Almost everything delivered to you – quickly, reliably, and affordably</p>
      </div>
      ...
      <HomeCard image={"https://images.ctfassets.net/23u853certza/471ILgDT92ZOsRUtayO8Gy/3653197562a27c83d18caa3fb4a12256/photocardsmall_wolt_market_v2.jpg?w=960&q=90&fm=webp"}/>
      <HomeCard image={"https://images.ctfassets.net/23u853certza/2PeZ6DypYynPSCEDHZbh1C/c978e38a82eb3f3331f184e67d2b4e00/photocardsmall_wolt_for_work.jpg?w=960&q=90&fm=webp"}/>
      <HomeCard image={"https://images.ctfassets.net/23u853certza/51WilVKmJ4MmFg3IBHK2ko/1d8652b44a5f77a8a68c22f1ab28db14/photocardsmall_woltapp.jpg?w=960&q=90&fm=webp"} />
      </div>
