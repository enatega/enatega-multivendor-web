  ...
  return (
    <div>
      ...
      <div className='grid gird-cols-1 md:grid-cols-2 my-[30px] gap-8'>
        ...
        subText={"The more you deliver, the more money you can earn. Get paid per delivery and for distance covered."}
        ...
        subText={"Choose your own hours and set your own schedule. Plus, no delivery experience required."}
        />
      </div>
